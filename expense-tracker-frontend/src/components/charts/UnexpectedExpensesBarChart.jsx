...
export default function UnexpectedExpensesBarChart({ data = [] }) {
    ...
    return (
        <ResponsiveContainer width="100%" height="100%">
            <BarChart
                data={processedData}
                layout="vertical"
                margin={{ top: 10, right: 70, left: 10, bottom: 10 }} // space for labels
            >
                {/* X Axis */}
                <XAxis
                    type="number"
                ...
                <YAxis
                    ...
                    dataKey="name"
                    tick={{ fill: "#9ca3af", fontSize: 12 }}
                    width={120} // slightly increased for long names
                    axisLine={false}
                    tickLine={false}
                />
